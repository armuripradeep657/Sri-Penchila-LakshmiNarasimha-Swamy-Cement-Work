...
const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    description:
      'Traditional hand-crafted precast cement window frames fitted with durable royal blue security iron grills. Meticulously cast by master artisans with 53-grade OPC cement. Termite-proof, weather-proof, and designed to last for generations.',
    category: 'WINDOW',
    ...
    isFeatured: true,
    sortOrder: 1,
    images: [{ id: 'img_kod_1', url: '/images/products/kodada-ketikelu.jpg', altText: 'Kodada Ketikelu precast cement windows with blue grills' }],
    variants: [
      { id: 'v_kod_2x2', name: '2ft × 2ft', sku: 'KOD-WIN-2x2', width: 2, height: 2, dimensionUnit: 'ft', price: 80000, stock: 30, availability: 'IN_STOCK', sortOrder: 0 },
      { id: 'v_kod_3x3', name: '3ft × 3ft', sku: 'KOD-WIN-3x3', width: 3, height: 3, dimensionUnit: 'ft', price: 120000, stock: 25, availability: 'IN_STOCK', sortOrder: 1 },
      { id: 'v_kod_4x3', name: '4ft × 3ft', sku: 'KOD-WIN-4x3', width: 4, height: 3, dimensionUnit: 'ft', price: 140000, stock: 20, availability: 'IN_STOCK', sortOrder: 2 },
      { id: 'v_kod_4x4', name: '4ft × 4ft', sku: 'KOD-WIN-4x4', width: 4, height: 4, dimensionUnit: 'ft', price: 160000, stock: 15, availability: 'IN_STOCK', sortOrder: 3 },
    ],
  },
  {
    id: 'prod_machine',
    ...
    description:
      'Industrial machine-pressed precast cement window frames fitted with royal blue iron security grills. Precision sharp edges, uniform finish, and exceptional load resistance at economical pricing.',
    category: 'WINDOW',
    ...
    isFeatured: true,
    sortOrder: 2,
    images: [{ id: 'img_mch_1', url: '/images/products/machine-ketikelu.jpg', altText: 'Machine Ketikelu machine-made cement windows with blue grills' }],
    variants: [
      { id: 'v_mch_2x2', name: '2ft × 2ft', sku: 'MCH-WIN-2x2', width: 2, height: 2, dimensionUnit: 'ft', price: 45000, stock: 40, availability: 'IN_STOCK', sortOrder: 0 },
      { id: 'v_mch_3x25', name: '3ft × 2½ft', sku: 'MCH-WIN-3x2.5', width: 3, height: 2.5, dimensionUnit: 'ft', price: 55000, stock: 35, availability: 'IN_STOCK', sortOrder: 1 },
      { id: 'v_mch_3x3', name: '3ft × 3ft', sku: 'MCH-WIN-3x3', width: 3, height: 3, dimensionUnit: 'ft', price: 60000, stock: 30, availability: 'IN_STOCK', sortOrder: 2 },
      { id: 'v_mch_4x3', name: '4ft × 3ft', sku: 'MCH-WIN-4x3', width: 4, height: 3, dimensionUnit: 'ft', price: 80000, stock: 25, availability: 'IN_STOCK', sortOrder: 3 },
      { id: 'v_mch_4x4', name: '4ft × 4ft', sku: 'MCH-WIN-4x4', width: 4, height: 4, dimensionUnit: 'ft', price: 120000, stock: 20, availability: 'IN_STOCK', sortOrder: 4 },
    ],
  },
  {
    id: 'prod_vent',
    ...
    description:
      'Decorative precast cement ventilation blocks with traditional jali (lattice) patterns. Perfect for bathroom ventilation, compound walls, staircases, and aesthetic airflow partitions.',
    category: 'WINDOW',
    ...
    isFeatured: true,
    sortOrder: 3,
    images: [{ id: 'img_vent_1', url: '/images/products/ventilators.jpg', altText: 'Authentic cement ventilator jali blocks' }],
    variants: [
      { id: 'v_vent_1x1', name: '1ft × 1ft', sku: 'VENT-1x1', width: 1, height: 1, dimensionUnit: 'ft', price: 16000, stock: 200, availability: 'IN_STOCK', sortOrder: 0 },
      { id: 'v_vent_2x1', name: '2ft × 1ft', sku: 'VENT-2x1', width: 2, height: 1, dimensionUnit: 'ft', price: 22000, stock: 150, availability: 'IN_STOCK', sortOrder: 1 },
    ],
  },
  {
    id: 'prod_gagulu',
    ...
    description:
      'Heavy-duty precast reinforced cement concrete well rings (Gagulu) for open wells, bore wells, soak pits, septic tanks, and irrigation drainage channels. Cast with high compressive concrete.',
    category: 'POOL',
    ...
    isFeatured: true,
    sortOrder: 4,
    images: [{ id: 'img_gag_1', url: '/images/products/gagulu.jpg', altText: 'Authentic Gagulu cement well rings in yard' }],
    variants: [
      { id: 'v_gag_2ft', name: '2ft Diameter Ring', sku: 'GAG-2FT', width: 2, height: 1, dimensionUnit: 'ft', price: 18000, stock: 50, availability: 'IN_STOCK', sortOrder: 0 },
      { id: 'v_gag_3ft', name: '3ft Diameter Ring', sku: 'GAG-3FT', width: 3, height: 1, dimensionUnit: 'ft', price: 22000, stock: 40, availability: 'IN_STOCK', sortOrder: 1 },
      { id: 'v_gag_4ft', name: '4ft Diameter Ring', sku: 'GAG-4FT', width: 4, height: 1, dimensionUnit: 'ft', price: 36000, stock: 30, availability: 'IN_STOCK', sortOrder: 2 },
    ],
  },
  {
    id: 'prod_bricks',
    ...
    slug: 'cement-bricks',
    description:
      'Solid precast cement concrete construction bricks and blocks. Cast with 53-grade OPC cement for superior load-bearing strength. 10,000+ units readily available in yard for immediate delivery.',
    category: 'BRICK',
    ...
    isFeatured: true,
    sortOrder: 5,
    images: [{ id: 'img_brk_1', url: '/images/products/bricks.jpg', altText: 'Authentic cement bricks stacked in yard' }],
    variants: [
      ...
      { id: 'v_brk_9x4_pc', name: '9×4 inches — Per Piece', sku: 'BRK-9x4-PC', width: 9, height: 4, dimensionUnit: 'in', price: 800, stock: 10000, availability: 'IN_STOCK', sortOrder: 1 },
      { id: 'v_brk_8x6_1k', name: '8×6 inches — Lot of 1000 Bricks', sku: 'BRK-8x6-1K', width: 8, height: 6, dimensionUnit: 'in', price: 900000, stock: 10, availability: 'IN_STOCK', sortOrder: 2 },
      { id: 'v_brk_9x4_1k', name: '9×4 inches — Lot of 1000 Bricks', sku: 'BRK-9x4-1K', width: 9, height: 4, dimensionUnit: 'in', price: 700000, stock: 10, availability: 'IN_STOCK', sortOrder: 3 },
    ],
  },
];
