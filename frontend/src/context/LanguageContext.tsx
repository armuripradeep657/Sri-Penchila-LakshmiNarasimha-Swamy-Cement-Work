...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Login & Profile
    login_title: 'Precast Portal Login',
    login_subtitle: 'Sign in with your mobile number & email to access wholesale contractor rates or owner controls.',
    fast_sign_in: '1-Click Fast Role Sign-In',
    auto_fills_phone: 'Auto-fills phone & email',
    role_prasad: '👑 Prasad (Admin)',
    role_owner: 'Owner',
    role_rajesh: '🏗️ Rajesh (Customer)',
    role_builder: 'Builder',
    field_mobile: 'Mobile Phone Number',
    field_mobile_hint: 'Receives 6-digit SMS OTP',
    field_email: 'Email Address',
    field_email_hint: 'For dispatch invoices & quotes',
    field_full_name: 'Full Name',
    field_firm_name: 'Contractor / Firm Name (Optional)',
    enter_6_digit_otp: 'Enter 6-Digit Verification OTP',
    simulated_sms_alert: 'Simulated SMS Alert',
    random_code_badge: 'Random Code',
    your_otp_code: 'Your 6-Digit One-Time Code:',
    expires_in_5m: 'Expires in 5 minutes',
    security_random_hint: 'Security feature: A unique, random OTP is generated on every request.',
  ...
  te: {
    ...
    // Login & Profile
    login_title: 'ప్రీకాస్ట్ పోర్టల్ లాగిన్',
    login_subtitle: 'హోల్‌సేల్ కాంట్రాక్టర్ రేట్లు లేదా యజమాని నియంత్రణల కొరకు మీ మొబైల్ నంబర్ మరియు ఇమెయిల్‌తో లాగిన్ అవ్వండి.',
    fast_sign_in: '1-క్లిక్ ఫాస్ట్ రోల్ లాగిన్',
    auto_fills_phone: 'ఫోన్ & ఇమెయిల్ ఆటో-ఫిల్ చేస్తుంది',
    role_prasad: '👑 ప్రసాద్ (అడ్మిన్ / యజమాని)',
    role_owner: 'యజమాని',
    role_rajesh: '🏗️ రాజేష్ (కస్టమర్ / బిల్డర్)',
    role_builder: 'బిల్డర్',
    field_mobile: 'మొబైల్ ఫోన్ నంబర్',
    field_mobile_hint: '6-అంకెల SMS OTP వస్తుంది',
    ...
    enter_6_digit_otp: '6-అంకెల ధృవీకరణ OTP నమోదు చేయండి',
    simulated_sms_alert: 'సిమ్యులేటెడ్ SMS అలర్ట్',
    random_code_badge: 'రాండమ్ కోడ్',
    your_otp_code: 'మీ 6-అంకెల వన్-టైమ్ కోడ్:',
    expires_in_5m: '5 నిమిషాల్లో ముగుస్తుంది',
    security_random_hint: 'భద్రతా ఫీచర్: ప్రతి లాగిన్ అభ్యర్థనకు కొత్త రాండమ్ OTP రూపొందించబడుతుంది.',
